  ...
  return (
    <div className="about-us-container">
      <div className="top_image">
        <img
          className="AboutUs_background_cover"
          src={AboutUs_background_cover}
        />
        <img
          src={AboutUs_background}
          alt=""
          className="AboutUs_background_image"
        />
  ...
  <div className="mission-content">
    <div className="mission-points">
      <div className="mission-point">
        ...
        <p>Provide <span className="highlight">free, high-quality coaching</span> for competitive exams such as JEE, NEET, and NDA.</p>
      </div>
      <div className="mission-point">
        <div className="checkbox">✓</div>
        <p>Enhance educational standards in underserved areas through innovative teaching approaches.</p>
      </div>
      <div className="mission-point">
        <div className="checkbox">✓</div>
        <p>Inspire students to pursue higher education and professional careers by addressing their academic and psychological needs.</p>
      </div>
    </div>
    <img
      src={AboutUs_Mission}
